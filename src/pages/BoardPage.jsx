  ...
  const cardData = [
    {
      ...
      image: '/lawsOSoverview/board_card1.jpg',
      details: [
        '📋 案由與法院層級設定',
        '⚖️ 辯護立場明確定義',
        '📝 案件描述詳細記錄',
    ...
    },
    {
      ...
      image: '/lawsOSoverview/board_card2.jpg',
      details: [
        '📝 便條紙卡記錄要點',
        '⚡ 爭點卡整理爭議',
        '💭 主張卡明確立場',
    ...
    },
    {
      ...
      image: '/lawsOSoverview/board_card3.jpg',
      details: [
        '🔍 相關法條智慧搜尋',
        '🤖 AI語意搜索功能',
        '⚖️ 法源依據確保',
    ...
    },
    {
      ...
      image: '/lawsOSoverview/board_card4.jpg?2',
      details: [
        '🔗 多判決連結推理',
        '📊 判決整合資訊',
        '🎯 共通性關聯分析',
    ...
    },
    {
      ...
      image: '/lawsOSoverview/board_card5.jpg?2',
      details: [
        '📊 相關案例提取',
        '🛡️ 防禦比例分析',
        '⚠️ 風險因素評估',
    ...
    },
    {
     ...
     image: '/lawsOSoverview/board_card6.jpg?2',
      details: [
        '📋 判決摘要歸納',
        '⚔️ 攻防策略分析',
        '🎯 原告弱點識別',
    ...
    },
    {
      ...
      image: '/lawsOSoverview/board_card7.jpg?2',
      details: [
        '📚 援引判例提取',
        '🔗 判決關聯分析',
        '💎 參考價值評估',
    ...
    },
    {
      ...
      image: '/lawsOSoverview/board_card8.jpg?2',
      details: [
        '🔍 特殊判決識別',
        '💡 異常案例分析',
        '🎯 洞察機會發現',
    ...
    },
    {
      ...
      image: '/lawsOSoverview/board_card9.jpg?2',
      details: [
        '📝 多卡片資訊整合',
        '⚖️ 各類訴狀生成',
        '🔄 即時卡片調整',
